...
app.locals.title = 'Presidents and Assholes'
app.locals.presidents = []
app.locals.presidents = [
  ...
  {number: 39, president: 'Jimmy Carter', birth_year: 1924, death_year: null, took_office: '1977-01-20', left_office: '1981-01-20', party: 
  'Democratic'},
...
app.get('/', (req, res) => {
  res.status(200).send('Presidents and Assholes!')
})

app.get('/api/v1/presidents', (req, res) => {
  res.status(200).json(app.locals.presidents)
})
